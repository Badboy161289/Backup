...
// src/firebase/storeInvoiceData.js
import { collection, addDoc } from "firebase/firestore";
import { db } from "./firebase.js"; // Import your initialized Firestore instance

const storeInvoiceData = async () => {
  try {
    // Define your initial data entries
    const initialDataEntries =
      {
        company: "Your Company",
        address: "123 Street, City, Country",
        date: "25-07-2024",
      ...
      const docRef = await addDoc(collection(db, "invoices"), initialDataEntries);
      console.log("Document written with ID: ", docRef.id);
